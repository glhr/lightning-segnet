...
python3 fusion-test.py --fusion custom --dataset cityscapes --modalities rgb,depthraw --save --bs 1 --save_xp fusion-rgb,d --decoders late --pretrained_last_layer --fusion_activ softmax
python3 fusion-test.py --fusion custom --dataset cityscapes --modalities rgb,depthraw --save --bs 1 --save_xp fusion-rgb,d --decoders late --fusion_activ softmax
