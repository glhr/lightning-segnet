...
},
{
    ...
    "test_set": "test",
    "checkpoints": {
        "rgb":"lightning_logs/2022-11-04 17-03-multispectralseg-c9-rgb,ir-rgb-epoch=22-val_mIoU_obj=0.2624.ckpt",
        "ssma_custom": "lightning_logs/2022-11-04 15-38-multispectralseg-c9-rgb,ir-ssma_custom-epoch=18-val_mIoU_obj=0.3071.ckpt",
        #"avg": "lightning_logs/2022-11-04 15-38-multispectralseg-c9-rgb,ir-avg-epoch=25-val_mIoU_obj=0.3013.ckpt"
    }
}
...
for config in configs:
    if config['dataset_name'] != "freiburg":
        continue
